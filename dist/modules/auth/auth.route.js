...
import { registerController, loginController, logoutController, refreshTokenController, verifyOtpController, resendOtpController } from "./auth.controller.js";
import { loginUserSchema, registerUserSchema, verifyOtpSchema, refreshTokenSchema, resendOtpSchema } from "./auth.schema.js";
const router = Router();
